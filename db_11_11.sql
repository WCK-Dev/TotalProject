...
INSERT INTO `boardkinds` VALUES (1,0,1,'자유게시판','Y','Y','Y'),(4,1,2,'알림 게시판','Y','Y','Y'),(5,0,3,'예시용 게시판','Y','Y','Y'),(7,0,4,'추가게시판','Y','Y','Y'),(8,0,5,'12312','Y','Y','Y'),(9,0,6,'asdasd','Y','Y','Y');
...
CREATE TABLE `menu` (
  ...
  `menu_ref` int NOT NULL DEFAULT '0',
  `menu_origin` int NOT NULL,
...
INSERT INTO `menu` VALUES (1,'1,2주차 프로젝트','2020-11-11 16:02:25','admin',NULL,NULL,'N',1,0,1,'user','','none'),(2,'3주차 프로젝트','2020-11-11 16:05:33','admin',NULL,NULL,'N',1,0,2,'user','','none'),(3,'4주차 프로젝트','2020-11-11 16:05:33','admin',NULL,NULL,'N',1,0,3,'user','','none'),(4,'5주차 프로젝트','2020-11-11 16:05:33','admin',NULL,NULL,'N',1,0,4,'user','','none'),(5,'추가 프로젝트','2020-11-11 16:05:33','admin',NULL,NULL,'N',1,0,5,'user','','none'),(6,'게시판','2020-11-11 16:05:33','admin',NULL,NULL,'N',2,1,1,'user','','none'),(7,'lv 3 메뉴항목 추가','2020-11-11 07:26:07','admin',NULL,NULL,'N',3,6,1,'manager','','none'),(8,'ㅌㅌㅌ','2020-11-11 07:32:48','admin',NULL,NULL,'Y',1,0,8,'admin','','gallery'),(9,'동영상 게시판','2020-11-11 09:11:37','admin',NULL,NULL,'N',1,0,9,'manager','','videoboard'),(10,'lv2 메뉴 추가','2020-11-11 18:22:14','admin',NULL,NULL,'N',2,1,1,'user','','none');
...
CREATE TABLE `user` (
  ...
  `manager_YN` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL DEFAULT 'N' COMMENT '매니저 권한 여부',
...
INSERT INTO `user` VALUES ('adm','1234','관리자계정','Y','Y','Y','Y','Y','Y','Y','Y'),('admin','1234','관리자','Y','Y','Y','Y','Y','Y','Y','Y'),('fusion','1234','퓨전소프트','Y','Y','Y','Y','Y','Y','N','N'),('fusion1','fusion1234','우치경','N','Y','Y','Y','N','Y','N','Y'),('fusion11','fusion1234','우치경','Y','Y','Y','Y','Y','Y','N','N'),('fusion1234','fusion1234','우치경','Y','N','N','N','N','N','N','N'),('fusionsoft','fusion1234','퓨전소프트','Y','Y','Y','Y','Y','Y','N','N'),('ktw1989','xodn1989','김태우','Y','Y','N','N','N','N','N','N'),('master','master1234','마스터계정','Y','Y','Y','Y','Y','Y','N','N'),('outside16','1234','퓨전','Y','Y','Y','Y','Y','Y','N','N'),('sjh1991','sjh1991','신지훈','Y','Y','Y','Y','Y','Y','N','N'),('syj1991','syj1991','송영주','N','N','N','N','N','N','N','N'),('user','1234','이용자','Y','Y','Y','Y','Y','Y','N','N'),('username','user1234','테스트사용자','Y','Y','Y','Y','Y','Y','N','N'),('wck','1234','우치경','Y','Y','Y','Y','Y','Y','N','N'),('wck1111','wck1111','우치경','N','N','N','N','N','N','N','N'),('wck1234','1234','우치경','Y','Y','Y','Y','Y','Y','N','N'),('wck1991','wck1991','김철수','N','N','N','N','N','N','N','N'),('yhs1234','1234','현수임','Y','Y','Y','Y','Y','Y','N','N'),('yhsyhs1','asd123','현수임','N','N','N','N','N','N','N','N');
...
-- Dump completed on 2020-11-11 19:12:32
