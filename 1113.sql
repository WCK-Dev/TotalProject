...
INSERT INTO `boardkinds` VALUES (1,0,1,'자유게시판','Y','Y','Y'),(4,1,2,'알림 게시판','Y','Y','Y'),(5,0,3,'예시용 게시판','Y','Y','Y'),(7,0,4,'추가게시판','Y','Y','Y'),(8,0,5,'12312','Y','Y','Y'),(10,0,6,'223','Y','Y','Y'),(11,0,7,'asdsad','Y','Y','Y');
...
INSERT INTO `menu` VALUES (1,'1주차','admin','2020-11-12 05:26:42','admin','2020-11-13 04:20:51','user/manager/admin','1주차 메뉴','#',1,1,NULL,NULL),(2,'게시판 프로젝트','admin','2020-11-12 05:26:56','admin','2020-11-12 07:49:51','user/manager/admin','1주차 중위메뉴','#',2,1,2,NULL),(3,'자유게시판','admin','2020-11-12 05:27:13','admin','2020-11-13 05:12:32','user/manager/admin','dep3 게시판 바로가기 메뉴 설정','boardList.do?b_bseq=1',3,1,2,3),(5,'3주차','admin','2020-11-12 05:27:53',NULL,NULL,'user/manager/admin','3주차 상위메뉴','#',1,5,NULL,NULL),(6,'설문조사 프로젝트','admin','2020-11-12 05:28:16','admin','2020-11-13 00:55:07','user/manager/admin','ㅅㅁㅈㅅ','serveyList.do',2,5,6,NULL),(7,'4주차','admin','2020-11-12 05:28:32','admin','2020-11-13 01:12:39','manager/admin','갤러리 프로젝트','#',1,7,NULL,NULL),(8,'갤러리','admin','2020-11-12 05:28:56','admin','2020-11-13 04:59:26','manager/admin','갤러리 프로젝트','galleryMain.do',2,9,8,NULL),(9,'5주차','admin','2020-11-12 05:29:04','admin','2020-11-12 08:37:39','user/manager/admin','ㅇㅇ','#',1,9,NULL,NULL),(10,'체크리스트','admin','2020-11-12 05:29:18','admin','2020-11-13 04:59:58','user/manager/admin','ㅇㅇ','checkListMain.do',2,7,10,NULL),(11,'3주차 더미 메뉴','admin','2020-11-12 05:32:00',NULL,NULL,'user/manager/admin','333','#',2,5,11,NULL),(12,'알림 게시판','admin','2020-11-12 07:35:37','admin','2020-11-13 05:12:15','user/manager/admin','알림 게시판 바로가기','boardList.do?b_bseq=4',3,1,2,12),(13,'예시용 게시판','admin','2020-11-12 07:35:55','admin','2020-11-13 05:12:21','user/manager/admin','예시용 게시판','boardList.do?b_bseq=5',3,1,2,13),(14,'추가 게시판','admin','2020-11-12 07:37:00','admin','2020-11-13 05:12:25','user/manager/admin','추가 게시판 바로가기','boardList.do?b_bseq=7',3,1,2,14),(15,'추가프로젝트','admin','2020-11-12 08:36:17','admin','2020-11-13 04:52:07','admin','최상위 메뉴 추가','#',1,15,NULL,NULL),(16,'야구게임','admin','2020-11-12 08:36:42','admin','2020-11-13 05:02:22','manager/admin','야구게임 게시판 바로가기','baseballList.do',2,15,16,NULL);
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='메뉴별 접근횟수, 접근한 유저 통계 테이블';
/*!40101 SET character_set_client = @saved_cs_client */;
...
LOCK TABLES `menulog` WRITE;
/*!40000 ALTER TABLE `menulog` DISABLE KEYS */;
/*!40000 ALTER TABLE `menulog` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `user` (
  ...
  `user_roll` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL DEFAULT 'user' COMMENT '유저 권한 롤 (user/manager/admin)',
...
INSERT INTO `user` VALUES ('adm','1234','관리자계정','admin','Y','Y','Y','Y','Y','Y'),('admin','1234','관리자','admin','Y','Y','Y','Y','Y','Y'),('fusion','1234','퓨전소프트','manager','Y','Y','Y','Y','Y','Y'),('fusion1','fusion1234','우치경','user','N','Y','Y','Y','N','Y'),('fusion11','fusion1234','우치경','user','Y','Y','Y','Y','Y','Y'),('fusion1234','fusion1234','우치경','user','Y','N','N','N','N','N'),('fusionsoft','fusion1234','퓨전소프트','manager','Y','Y','Y','Y','Y','Y'),('ktw1989','xodn1989','김태우','manager','Y','Y','N','N','N','N'),('master','master1234','마스터계정','admin','Y','Y','Y','Y','Y','Y'),('outside16','1234','퓨전','user','Y','Y','Y','Y','Y','Y'),('sjh1991','sjh1991','신지훈','user','Y','Y','Y','Y','Y','Y'),('syj1991','syj1991','송영주','user','N','N','N','N','N','N'),('user','1234','이용자','user','Y','Y','Y','Y','Y','Y'),('username','user1234','테스트사용자','user','Y','Y','Y','Y','Y','Y'),('wck','1234','우치경','user','Y','Y','Y','Y','Y','Y'),('wck1111','wck1111','우치경','user','N','N','N','N','N','N'),('wck1234','1234','우치경','user','Y','Y','Y','Y','Y','Y'),('wck1991','wck1991','김철수','user','N','N','N','N','N','N'),('yhs1234','1234','현수임','user','Y','Y','Y','Y','Y','Y'),('yhsyhs1','asd123','현수임','user','N','N','N','N','N','N');
...
-- Dump completed on 2020-11-13 14:57:43
