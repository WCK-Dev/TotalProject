...
) ENGINE=InnoDB AUTO_INCREMENT=25 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='숫자야구 게시글 레코드 테이블';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=59 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='야구게임 댓글 테이블 (정답확인)';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `board` VALUES (8,0,0,1,'두번째 원글 작성 테스트','1234','2020-08-31 04:56:36','wck',18,8,0,'',1),(9,0,8,2,'두번째 원글의 첫번째 답글','1313','2020-08-31 05:36:54','wck',8,8,0,'',1),(11,0,0,1,'수정용 글을 작성합니다.(관리자수정)','관리자가 게시글 내용을 수정하였습니다.','2020-08-31 08:03:31','user',24,11,0,'',1),(19,0,0,1,'1234','1234','2020-09-02 08:02:39','master',12,19,0,'',1),(21,0,0,1,'마스터계정 비밀글 등록','마스터계정으로 비밀글을 등록합니다','2020-09-02 08:06:42','master',8,21,1,'master1234',1),(22,1,0,1,'마스터계정 공지글등록','마스터계정으로 공지글을 등록합니다.','2020-09-02 08:07:01','master',0,22,0,'',1),(23,1,0,1,'공지글등록 테스트 2','공지글등록 테스트 2','2020-09-02 08:09:33','master',0,23,0,'',1),(24,0,0,1,'13','13','2020-09-03 08:05:08','admin',2,24,0,'',1),(25,0,0,1,'관리자 비밀글 수정','관리자 비밀글 !\r\n\r\n수정합니다.','2020-09-03 08:06:22','admin',9,25,1,'admin1234',1),(26,0,0,1,'유저 게시글 작성','유저 게시글 작성입니다.','2020-09-03 08:06:50','user',4,26,0,'',1),(27,0,0,1,'유저 비밀글 작성!','유저 비밀글 작성입니다.','2020-09-03 08:07:11','user',10,27,1,'12341234',1),(28,1,0,1,'관리자 공지글 작성 테스트','공지글 내용입니다.','2020-09-03 08:08:15','admin',0,28,0,'',1),(38,0,0,1,'더미게시글 3','더미게시글3','2020-09-03 10:04:20','wck',4,38,1,'wck1234',1),(39,0,0,1,'더미게시글 4','더미게시글 4','2020-09-03 10:04:28','wck',3,39,1,'1313',1),(40,0,0,1,'더미게시글 5','더미게시글 5','2020-09-03 10:04:55','wck',3,40,0,'',1),(41,0,0,1,'더미게시글 6','더미게시글 6','2020-09-03 10:05:09','user',1,41,0,'',1),(42,0,0,1,'더미게시글 7','더미게시글 7','2020-09-03 10:05:20','user',5,42,1,'1234',1),(43,0,0,1,'더미게시글 8','더미게시글 8','2020-09-03 10:05:33','user',3,43,0,'',1),(44,0,0,1,'더미게시글 9','더미게시글 9','2020-09-03 10:05:33','user',1,44,0,'',1),(45,0,0,1,'더미게시글 10','더미게시글 10','2020-09-03 10:05:33','user',2,45,0,'',1),(46,0,0,1,'더미게시글 11','더미게시글 11','2020-09-03 10:05:33','user',3,46,0,'',1),(49,0,0,1,'더미게시글 14','더미게시글 14','2020-09-03 10:05:33','user',14,49,0,NULL,1),(50,0,0,1,'더미게시글 15','더미게시글 15','2020-09-03 10:05:33','user',215,50,0,NULL,1),(53,0,52,3,'계층3','1234','2020-09-04 00:50:52','wck',1,50,0,NULL,1),(54,0,50,2,'더미게시글 15 의 답글2','2','2020-09-04 00:51:03','wck',12,50,0,NULL,1),(55,0,0,1,'비밀글','123','2020-09-04 00:52:36','wck',177,55,1,'1234',1),(64,0,0,1,'문의게시판 글 작성','문의게시판에 글을 작성','2020-09-07 02:52:03','user',35,64,0,'',4),(65,0,50,2,'더미게시글 15 의 답글3','3','2020-09-07 04:51:25','admin',1,50,0,NULL,1),(67,1,0,1,'공지글등록','공지등록 테스트','2020-10-28 00:26:21','admin',0,67,0,NULL,4),(68,0,0,1,'읽지않은 게시글','알림형 게시판 테스트','2020-10-28 00:27:03','admin',25,68,0,'',4),(70,0,0,1,'관리자 비밀글 수정','관리자가 작성한 비밀글을 직접 수정함','2020-10-28 05:06:12','admin',35,70,1,'1234',5),(71,0,0,1,'yhs 게시글작성','비밀글로작성함 ㅎㅎ','2020-10-28 05:32:34','yhs1234',14,71,1,'1234',5),(72,1,0,1,'공지글 수정','공지글 수정테스트','2020-10-28 05:34:34','admin',1,72,0,NULL,5),(73,0,64,2,'문의게시판 글 작성 의 답글','yhs가 답글을 작성함','2020-10-28 05:52:35','yhs1234',8,64,0,NULL,4),(77,0,27,2,'유저 비밀글 작성! 의 답글','2323','2020-11-03 05:55:41','wck',1,27,0,NULL,1),(79,0,68,2,'읽지않은 게시글 의 답글','신규유저 권한 변경후 답글작성테스트','2020-11-03 07:55:38','outside16',12,68,0,NULL,4),(80,0,0,1,'신규유저 신규 게시판','일반글 작성','2020-11-03 07:58:26','outside16',2,80,0,'',7),(81,0,0,1,'신규유저 신규게시판 비밀글','비밀글작성\n\n12341234','2020-11-03 07:58:48','outside16',3,81,1,'1234',7),(82,0,64,2,'문의게시판 글 작성 의 답글(신규유저)','신규유저의 답글작성란','2020-11-04 00:42:36','outside16',1,64,0,NULL,4),(83,0,79,3,'읽지않은 게시글 의 답글 의 답글','ㅇㅇ','2020-11-04 00:46:29','outside16',1,68,0,NULL,4),(84,0,0,1,'신규유저','비밀글작성\n\n비밀글작성을 시험해봅니다.','2020-11-04 00:49:40','outside16',1,84,1,'1234',1);
...
INSERT INTO `boardkinds` VALUES (1,0,1,'자유게시판','Y','Y','Y'),(4,1,2,'알림 게시판','Y','Y','Y'),(5,0,3,'예시용 게시판','Y','Y','Y'),(7,0,4,'추가게시판','N','N','N');
...
INSERT INTO `gallery` VALUES (1,'태그 전부 수정','태그 전부를 수정합니다\r\n로 수정합니다.','2020-09-15',85,'가을,바다,사람','wck'),(2,'테스트 작성글','갤러리 테스트 글을 작성합니다 ^0^','2020-09-15',25,'테스트,이미지','wck'),(3,'건물사진','건물사진입니다\r\n\r\n레스토랑이랑 집입니다.','2020-09-15',12,'건물,음식,레스토랑','wck'),(4,'애완동물','pets','2020-09-15',20,'동물,고양이,강아지, 펫','wck'),(6,'아기','아기사진입니다\r\n\r\n귀엽죠?','2020-09-15',39,'아기,사람,귀여움,웃음','wck'),(7,'학생이미지','학생아이콘을 추가해봤어요\r\n\r\n잘 사용하시길 바랍니다 ^^','2020-09-15',13,'학생,아이콘,야나,두','wck'),(8,'제발!!!','ㅈㅂㅈㅂ!!!','2020-09-16',22,'동물,웃긴사진,고양이','wck'),(9,'제발!!','하느님 제발!!','2020-09-16',25,'웃긴사진,카툰,웃음','wck'),(12,'고양이썬더','고양이썬더','2020-09-16',8,'웃긴사진,동물,고양이','wck'),(13,'동물사진','사자\r\n\r\n사슴','2020-09-16',53,'동물,사자,사슴,맹수','wck'),(14,'만두','만두사진이에요\r\n\r\n맛있어보여요','2020-09-17',9,'음식,만두,저녁','wck'),(15,'케이크','케이크사진입니다.','2020-09-17',10,'음식,생일,케이크','wck'),(16,'나무','나무사진','2020-09-17',17,'식물,숲,테스트','wck'),(17,'꿀벌','귀여운 꿀벌 \r\n\r\n:D','2020-09-17',12,'동물,곤충,벌','wck'),(19,'체크 이미지','업로드해봅니다\r\n\r\n하하하\r\n\r\n길게 글을 늘여써서 검색이 정상적인지 확인합시다.','2020-09-17',16,'이미지,체크,초록,컬러','wck'),(20,'컬러테스트','여러가지 색상을 담은 이미지입니다.\r\n\r\n화려한 느낌을 줍니다','2020-09-17',78,'컬러,추가,테스트','wck'),(22,'카카오','캐릭터 이미지\r\n\r\n\r\n라이언과 카카오 프렌즈','2020-09-18',28,'카카오,캐릭터,라이언','user'),(23,'사람의 행동','사람 이미지\r\n\r\n2장입니다.','2020-09-18',6,'사람,실사,캐릭터','user'),(24,'강원도 캐릭터입니다.','호랑이랑 곰?\r\n\r\n인거같아요 \r\n\r\n귀엽습니다.','2020-09-18',33,'호랑이,곰,동물,캐릭터','user'),(25,'두드림','두드림 대표캐릭터\r\n\r\n\'두두\' 입니다.','2020-09-18',26,'두두,캐릭터,두드림','user'),(26,'동물','동물','2020-09-18',46,'동물,테스트','user'),(27,'동물','라이언도 동물이지않을까','2020-09-18',7,'동물,카카오,라이언','user'),(30,'귀여운 동물 캐릭터(수정)','그리기쉽고 귀여운 캐릭터 이미지에요\r\n\r\n따라 그려봅시다 :D\r\n\r\n(돼지 이미지는 삭제되었습니다 ㅜㅜ)','2020-09-18',22,'동물,캐릭터,고양이,개','wck'),(32,'베니고마','베니고마라는 캐릭터에요','2020-09-18',24,'베니고마,캐릭터,물개','wck'),(33,'슈퍼카','자동차 이미지입니다.','2020-09-18',59,'슈퍼카,람보르기니,코닉세그','user'),(35,'갤러리 통합 업로드 테스트','업로드 해보기','2020-10-28',26,'갤러리,통합,업로드','wck'),(36,'갤러리 업로드 수정을 해봅시다','갤러리에다가 글 업로드\r\n\r\n이미지 하나 쳐내고, 이미지 하나 추가함\r\n\r\n태그는 힝힝 삭제하고, TOT추가함','2020-10-29',33,'통합,테스트,TOT','wck');
...
CREATE TABLE `log` (
  ...
  `b_seq` int NOT NULL,
  PRIMARY KEY (`l_seq`)
) ENGINE=InnoDB AUTO_INCREMENT=70 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='사용자별 조회 / 답변 로그 테이블';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `tag` VALUES (21,'바다',7,'2020-09-15',1),(28,'가을',7,'2020-09-15',1),(29,'사람',7,'2020-09-15',1),(30,'테스트',18,'2020-09-15',2),(31,'이미지',18,'2020-09-15',2),(32,'건물',8,'2020-09-15',3),(34,'음식',8,'2020-09-15',3),(35,'레스토랑',8,'2020-09-15',3),(36,'동물',16,'2020-09-15',4),(37,'고양이',16,'2020-09-15',4),(38,'강아지',16,'2020-09-15',4),(39,